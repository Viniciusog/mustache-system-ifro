...
public class PaymentView extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        edDatePayment = new javax.swing.JFormattedTextField();
        edTotalPaymentAmount = new javax.swing.JFormattedTextField();
        ...
        jLabel30.setText("ID CONTA DO PAGAMENTO");
        ...
        jLabel34.setText("ID CAIXA DO PAGAMENTO");

        jLabel2.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("CADASTRAR RECEBIMENTOS");

        try {
            edDatePayment.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("##/##/####")));
        } catch (java.text.ParseException ex) {
            ex.printStackTrace();
        }
        edDatePayment.setToolTipText("formato dd/mm/aaaa");

        edTotalPaymentAmount.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#,###.00"))));
        edTotalPaymentAmount.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(edDatePayment, javax.swing.GroupLayout.PREFERRED_SIZE, 70, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(edTotalPaymentAmount, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(jLabel32)))
                            .addComponent(edIdAccount)
                            .addComponent(edIdCashier))
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(edIdAccount, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(jLabel34)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(edIdCashier, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(btCancel)
                        .addGap(22, 22, 22)
                        .addComponent(btSave)))
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(jLabel29)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(edDatePayment, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(jLabel32)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(edTotalPaymentAmount, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap(107, Short.MAX_VALUE))
        );

        jTabbedPane1.addTab("CADASTRAR RECEBIMENTOS", jPanel2);
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "ID DA CONTA", "ID DO CAIXA", "DATA DO PAGAMENTO", "Valor Total Pagamento"
            }
        ) {
        ...
        btEdit.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/baseline_add_white_18dp.png"))); // NOI18N
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(edSearch, javax.swing.GroupLayout.PREFERRED_SIZE, 296, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jTabbedPane1.addTab("LISTAR RECEBIMENTOS", jPanel3);
    ...
    private void btDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btDeleteActionPerformed
        ...
        if (selectedRow >= 0) {
            ...
            pmnt.setId_payment(Integer.parseInt(table.getValueAt(selectedRow, 0).toString()));
            PaymentDAO.delete(pmnt);
            buildTable("");
    ...
    private void btEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEditActionPerformed
        ...
        if (selectedRow >= 0) {
            ...
            edDatePayment.setText(table.getValueAt(selectedRow, 3).toString());
    ...
    private boolean verifyValuesIfItsNotEmpty() {
        ...
        if (edDatePayment.getText().isEmpty()) {
            haveEmptyValue = true;
        }
        if (edTotalPaymentAmount.getText().isEmpty()) {
            haveEmptyValue = true;
        }
    ...
    private void saveProduct() {
        if (!verifyValuesIfItsNotEmpty()) {
            Payment pmnt = new Payment();
            pmnt.setId_payment(Integer.parseInt(edId.getText()));
            pmnt.setId_acc_payment(Integer.parseInt(edIdAccount.getText()));
            pmnt.setId_cashier_payment(Integer.parseInt(edIdCashier.getText()));
            pmnt.setDate_payment(edDatePayment.getText());
            pmnt.setTotal_payment_amount(Float.parseFloat(edTotalPaymentAmount.getText()));

            PaymentDAO.insert(pmnt);
            buildTable("");
            jTabbedPane1.setSelectedIndex(1);
            clear();
        } else {
    ...
    private void buildTable(String name) {
        PaymentDAO ptDAO = new PaymentDAO();
        List<Payment> list = ptDAO.getListPayment(name);
        DefaultTableModel tableModel = (DefaultTableModel) table.getModel();
        tableModel.setRowCount(0);

        for (Payment pmnt : list) {
            tableModel.addRow(new Object[]{pmnt.getId_payment(), pmnt.getId_acc_payment(), pmnt.getId_cashier_payment(), pmnt.getDate_payment(), pmnt.getTotal_payment_amount()});
        }

    }

    private void clear() {
        edDatePayment.setText(null);
        edId.setText(null);
        edIdAccount.setText(null);
        edIdCashier.setText(null);
        edTotalPaymentAmount.setText(null);
    }
    ...
    private javax.swing.JFormattedTextField edDatePayment;
    ...
    private javax.swing.JFormattedTextField edTotalPaymentAmount;
